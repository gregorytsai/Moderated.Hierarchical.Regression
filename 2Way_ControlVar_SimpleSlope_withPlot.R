##################################################################################
##2016.2.28
##Can be very slow if your data is large, use with caution
...
result$simpleSlope=matrix(nrow=1,ncol=11)
colnames(result$simpleSlope)=c("Dep. Var.","Pred. Var.","Mod. Var.","Plot name",
                               "Mod.Group","Simple Slope","SE",
                               "t-Value","p-Value","Low Pred.Point","High Pred.Point")
result$simpleSlopeCount=1
